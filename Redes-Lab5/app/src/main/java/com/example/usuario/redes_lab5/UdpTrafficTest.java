 ...
 */
public class UdpTrafficTest implements Runnable
{
    private String ip;
    private int puerto;
    ...
    public UdpTrafficTest(String ip, int puerto, MainActivity pal)
    {
        this.ip=ip;
        principal=pal;
        this.puerto=puerto;
        ...
        while(principal.probando)
        {
            try
            {
                ...
                if(mensaje!=null)
                {
                    ...
                    principal.cantidadEnviado++;
                    System.out.println("Socket UDP: Mensaje Enviado"+mensaje);
                }
            }
            catch(Exception e)
            {
                principal.cantidadErrores++;
                System.out.println("Socket UDP: Error al enviar"+e.getMessage());
                e.printStackTrace();
            }


        }
        System.out.println("Socket UDP: Cerrando...");
        cerrarConexion();
